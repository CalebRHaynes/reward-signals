...
for s = 1:length(subjects)
    ...
    for c = 1:length(conditions)
        ...
        disp(msg);
         ...
         if strcmp(condition,'sub')
            filename = fullfile(maindir, 'data',[condition '-' num2str(subject) '.csv']);
        else
            break;
        end
        delimiter = ',';
        ...
        SlotChoice = dataArray{:, 1};
        Reward = dataArray{:, 2};
        TrialType = dataArray{:, 3};
        ...
        result = RL_2P(SlotChoice, Reward);
